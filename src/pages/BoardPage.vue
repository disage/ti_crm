        ...
        <q-card>
            ...
            <q-card-section class="table-container">
                <q-table ref="tableRef" :rows="rows" :columns="columns" row-key="id" v-model:pagination="pagination"
                    virtual-scroll flat bordered table-class="my-table" table-layout="auto"
                    ...
                    <template v-slot:header="props">
                        <q-tr>
                            ...
                            <q-th v-for="(col, index) in columns" :key="col.name" :style="{ width: col.width + 'px' }">
                                <div class="resizable-header"  draggable="true" @dragstart="onDragStart(index)"
                                        ...
                                        <q-list>
                                            <q-item clickable>
                                                <q-item-section>
                                                    ...
                                                    <q-select v-model="col.type" :options="availableTypes" dense
                                                        borderless @update:model-value="onColumnTypeChange(col)" />
                                                </q-item-section>
                                            </q-item>
                                            <q-item clickable v-close-popup @click="renameColumn(col.name)">
                                                <q-item-section>Rename</q-item-section>
                                            </q-item>
                                            <q-item clickable v-if="col.type === 'select'" flat dense icon="settings"
                    ...
                    <template v-slot:body="props">
                        <q-tr :props="props">
                            ...
                            <q-td v-for="(col, index) in columns" :key="col.name">
